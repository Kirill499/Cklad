...
{
    public partial class amendmark : Form
    {
        string s;
        int i = 0;
        public amendmark()
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                database.Open();
                //MessageBox.Show(s);
                string queryString = "UPDATE Mark SET  Mark.title = '" + textBox1.Text + "', " +
                " WHERE (Mark.id_Mark = " + s + " ) ";
        ...
        private void amendmark_Activated(object sender, EventArgs e)
        {
            if (i == 0)
            {
                Provider main = this.Owner as Provider;
